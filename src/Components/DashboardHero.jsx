...
export const DashboardHero = () => {
  ...
  return (
    ...
    <div className={styles.info}>
      ...
      <ul>
        <p><span className={styles.number}>1</span>Connect to GitHub to verify your code contributions</p>
        <p><span className={styles.number}>2</span>Verify activity on Ethereum or Linea</p>
        <p><span className={styles.number}>3</span>Mint your membership NFT.</p>
      </ul>
